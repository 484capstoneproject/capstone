                                ...
                                <asp:Panel ID="postingFormLearn" runat="server" style="display:none">
								  <form id="Form2">
									<h5 class="pt-4">Post Details</h5>
									  <div class="form-group">
										<label for="learntitle">Learning Opportunity Title</label>
										<input type="learntitle" class="form-control" id="learningTitle" aria-describedby="learntitle" placeholder="Enter" runat="server">
									  </div>
								  
								  <div class="row pt-2 pb-3">
								  	<div class="col">
								 		 <label for="chooseOppType">Opportunity Type</label>
								  		 <select class="form-control w-75 mb-3" id="learingType" runat="server">
											  <option>Shadowing</option>
											  <option>Career Event</option>
											  <option>Other</option>
								  		 </select>
								    ...
								    <div class="col">
									   <div class="form-group">
											<label for="CareerClusterLearn">Career Cluster</label>
											<select class="form-control w-75" id="careerClusterLearn" runat="server">
											  <option>Select</option>
											  <option>Agriculture, Food and Natural Resources</option>
											  <option>Architecture and Construction</option>
											  <option>Business Management and Administration</option>
									  	...
									  	<div class="form-group">
 										   <label for="descLearn">Description</label>
 										   <textarea class="form-control" id="description" rows="3" placeholder="Tell potential candidates about your posting. Be as descriptive as you can." runat="server"></textarea>
									  </div> 
									  <div class="form-group">
											  <h5 class="pt-4">Edit Application Deadline</h5>
										      <div class="row w-75">
										      	<div class="col">
											      <label for="selectMonth">Month</label>
													<select class="form-control" id="monthDrop" runat="server">
													  <option>January</option>       
   													  <option>February</option>       
   													  <option>March</option>       
   													  <option>April</option>       
										      	...
										      	<div class="col">
											      <label for="selectDay">Day</label>
													<select class="form-control" id="dayDrop" runat="server">
													    <option>1</option>       
   														<option>2</option>       
   														<option>3</option>       
   														<option>4</option>       
										      ...
										      <div class="col">
											      <label for="selectYear">Year</label>
													<select class="form-control" id="yearDrop" runat="server">
													    <option>2019</option>       
   														<option>2020</option>       
   														<option>2021</option>       
   														<option>2022</option>       
