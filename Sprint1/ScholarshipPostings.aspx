<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScholarshipPostings.aspx.cs" Inherits="ScholarshipPostings" %>
           ...
           <asp:Button id="SignOut" type="submit" class="btn btn-maingreen sign-out btn-sign-out" runat="server" Text="Sign Out" OnClick="SignOut_Click"></asp:Button>
            ...
            <ul class="nav flex-column sidebar-links">
              ...
              <li class="nav-item-side">
                ...
                <li class="nav-item-side">
                <a class="nav-link nav-link-side sidebar-active" href="ScholarshipPostings.aspx">
                  <i data-feather="clipboard"></i>
