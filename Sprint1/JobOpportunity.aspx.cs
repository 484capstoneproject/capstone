...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void BtnSaveChanges_Click1(object sender, EventArgs e)
    {
        ...
        int LoginEntityID = (int)Session["EntityID"];
            ...
            JobPostingsClass newPost = new JobPostingsClass(txtJobTitle.Value, dropJobType.Value, 
                dropCareerCluster.Value, txtareaDescription.Value, dropMonth.Value, dropDay.Value, dropYear.Value, LoginEntityID);
