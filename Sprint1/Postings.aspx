<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Postings.aspx.cs" Inherits="Postings" %>
                    ...
                    <form id="formJob" runat="server">
						...
						<div class="modal fade" id="newPostModal" tabindex="-1" role="dialog" aria-labelledby="newPostModalLabel" aria-hidden="true">
						  <div class="modal-dialog modal-lg" role="document">
						   ...
						   <li class="nav-item">
						     <a class="nav-link active border-left-plain" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Job Opportunity</a>
						   </li>
						   <li class="nav-item">
							  ...
							  <!-- JOB FORM CONTENT -->
								    ...
								    <div class="row pt-2 pb-3">
								  	<div class="col">
                                         ...
                                         <select class="form-control w-75 mb-3 form-selector" id="dropJobType"  runat="server">
									   ...
									   <div class="form-group">
										...
										<div class="form-group pt-1">
									  	...
									  	<div class="form-group">
                                           ...
                                           <textarea class="form-control form-entry-all-borders" runat="server" id="txtareaDescription" rows="3" placeholder="Tell potential candidates about your posting. Be as descriptive as you can."></textarea>
									  </div> 
									  <div class="form-group">
