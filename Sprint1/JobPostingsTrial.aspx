<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobPostingsTrial.aspx.cs" Inherits="JobPostingsTrial" %>
		 	...
		 	<div class="card bg-white p-0 mt-3" style="height: 40vh;">
  			...
  			<div class="mt-auto w-100 bd-highlight bg-mainblue pl-1">
		        ...
		        <div class="pt-0 justify-content-between d-flex w-100 mb-3">		
			        ...
			        <p class="card-text">Break into the workd of finance with this exciting new position. No experience required, our top-notch team will teach you everything you need to know about being a Finance Analyst and provide you great opportunities to learn about other jobs in Finance.</p>
